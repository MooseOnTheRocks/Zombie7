...
public abstract class GrenadeStagedItem extends StagedItem<GrenadeStagedItem> {
    ...
    public static StagedItemEventHandler<GrenadeStagedItem> doCancel(String stageDefault) {
        return view -> {
    ...
    public static StagedItemEventHandler<GrenadeStagedItem> doReady(String stageDefault) {
        return view -> {
            view.item.playSoundReloadCancel(view.stack, view.entity);
            // Note: Could cancel pressingShoot as well.
            view.playerState.setPressingReload(false);
