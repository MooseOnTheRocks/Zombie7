...
public class Z7StatusEffects {
    ...
    public static final Z7StatusEffect STATUS_EFFECT_HEALING = registerStatusEffect("healing", new Z7HealingStatusEffect());

    public static final Z7StatusEffect STATUS_EFFECT_INFECTION = registerStatusEffect("infection", new Z7InfectionStatusEffect());

    public static final Z7StatusEffect STATUS_EFFECT_BLEEDING = registerStatusEffect("bleeding", new Z7BleedingStatusEffect()
    ...
    public static final Z7StatusEffect STATUS_EFFECT_BLEEDING_LONG = registerStatusEffect("bleeding_long", new Z7BleedingLongStatusEffect());

    public static final Z7StatusEffect STATUS_EFFECT_CONCUSSION_LONG = registerStatusEffect("concussion_long", new Z7ConcussionLongStatusEffect()
    ...
    public static final Z7StatusEffect STATUS_EFFECT_CONCUSSION = registerStatusEffect("concussion", new Z7ConcussionStatusEffect()
    ...
    public static final Z7StatusEffect STATUS_EFFECT_BROKEN_BONE = registerStatusEffect("broken_bone", new Z7BrokenBoneStatusEffect()
    ...
    public static final Z7StatusEffect STATUS_EFFECT_TWISTED_ANKLE = registerStatusEffect("twisted_ankle", new Z7TwistedAnkleStatusEffect()
