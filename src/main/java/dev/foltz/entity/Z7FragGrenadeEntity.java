...
public class Z7FragGrenadeEntity extends Z7GrenadeEntity {
    private static final TrackedData<Integer> FUSE_TIME = DataTracker.registerData(Z7FragGrenadeEntity.class, TrackedDataHandlerRegistry.INTEGER);

    public Z7FragGrenadeEntity(EntityType<? extends Z7GrenadeEntity> entityType, World world) {
