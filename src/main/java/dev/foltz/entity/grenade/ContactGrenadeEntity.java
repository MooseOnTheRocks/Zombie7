...
public class ContactGrenadeEntity extends Z7GrenadeEntity {
    private static final TrackedData<Integer> FUSE_TIME = DataTracker.registerData(ContactGrenadeEntity.class, TrackedDataHandlerRegistry.INTEGER);

    public ContactGrenadeEntity(EntityType<? extends Z7GrenadeEntity> entityType, World world) {
