...
public class StickyGrenadeEntity extends Z7GrenadeEntity {
    private static final TrackedData<Integer> FUSE_TIME = DataTracker.registerData(StickyGrenadeEntity.class, TrackedDataHandlerRegistry.INTEGER);

    protected Entity entityStuck = null;
    protected Vec3d stuckOffset = Vec3d.ZERO;

    public StickyGrenadeEntity(EntityType<? extends Z7GrenadeEntity> entityType, World world) {
