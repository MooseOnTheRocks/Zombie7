...
public class Z7StickyGrenadeEntityRenderer extends EntityRenderer<Z7StickyGrenadeEntity> {
    ...
    @Override
    public void render(Z7StickyGrenadeEntity grenadeEntity, float yaw, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int light) {
    ...
    @Override
    public Identifier getTexture(Z7StickyGrenadeEntity grenadeEntity) {
        if (grenadeEntity.isActive()) {
