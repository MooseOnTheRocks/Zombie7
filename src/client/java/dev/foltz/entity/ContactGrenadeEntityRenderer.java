...
public class ContactGrenadeEntityRenderer extends EntityRenderer<ContactGrenadeEntity> {
    ...
    public ContactGrenadeEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
    }
    ...
    @Override
    public void render(ContactGrenadeEntity grenadeEntity, float yaw, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int light) {
    ...
    @Override
    public Identifier getTexture(ContactGrenadeEntity grenadeEntity) {
        if (grenadeEntity.isActive()) {
