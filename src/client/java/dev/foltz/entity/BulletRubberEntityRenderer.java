...
public class BulletRubberEntityRenderer extends EntityRenderer<BulletRubberEntity> {
    ...
    @Override
    public void render(BulletRubberEntity bulletEntity, float yaw, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int light) {
