...
public class BowlingBallGrenadeEntityRenderer extends EntityRenderer<BowlingBallGrenadeEntity> {
    ...
    public BowlingBallGrenadeEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
    }
    ...
    @Override
    public void render(BowlingBallGrenadeEntity grenadeEntity, float yaw, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int light) {
...
//        s *= 0.4;
    ...
    @Override
    public Identifier getTexture(BowlingBallGrenadeEntity bowlingBallEntity) {
