...
public class Z7FragGrenadeEntityRenderer extends EntityRenderer<Z7FragGrenadeEntity> {
    ...
    @Override
    public void render(Z7FragGrenadeEntity grenadeEntity, float yaw, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int light) {
